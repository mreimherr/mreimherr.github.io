function [x,z,u,k] = ...
  group_lasso_warmstart(A, b, lambda, p, rho, alpha, x0, z0, u0)
% modified from Boyd's group_lasso  
% Solve group lasso problem via ADMM with warm start x0, z0, u0
%
...
function z = shrinkage(x, kappa)
    ...
    z = max(0,1 - kappa/norm(x))*x; %changed by Matt
end
